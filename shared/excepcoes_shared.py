...
# Foi adicionado NomeClienteInvalido e  StockInsuficiente   e IncrementoInvalido
# ----------------------------------
...
class StockInsuficiente(ExcepcaoValidacao):
    def __init__(self):
        super().__init__(
            "Stock insuficiente.",
...
class IncrementoInvalido(ExcepcaoValidacao):
    def __init__(self):
        super().__init__(
            "Incremento inválida.",
            OpCodes.INCREMENTO_INVALIDO
        )
...
class NomeClienteInvalido(ExcepcaoValidacao):
    def __init__(self):
        super().__init__(
            "Nome do Cliente inválido.",
            OpCodes.NOME_CLIENTE_INVALIDO
        )
...
class ProdutoNaoExistePreco(ExcepcaoNegocio):
    def __init__(self, nome=""):
        super().__init__(
            f"O produto {nome} não existe." if nome else "Produto não existe.",
            OpCodes.PRODUTO_NAO_EXISTE_PRECO
        )
